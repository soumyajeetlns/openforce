...
var __reduce_23 = _$esUtils_7.reduce;

var __stringWithLength_23 = _$validators_15.stringWithLength;

var __os_23 = require("os");
...
var _$config_23 = {
  projectRoot: {
    ...
    validate: function (value) {
      return value === null || __stringWithLength_23(value);
    },
    message: 'should be string'
  },
  hostname: {
    defaultValue: function () {
      return __os_23.hostname();
    },
    message: 'should be a string',
    validate: function (value) {
      return value === null || __stringWithLength_23(value);
  ...
  logger: ___extends_23({}, schema.logger, {
    defaultValue: function () {
      return getPrefixedConsole();
    }
  }),
  releaseStage: ___extends_23({}, schema.releaseStage, {
    defaultValue: function () {
  ...
  proxy: {
    ...
    message: 'should be a string',
    validate: function (value) {
      return value === undefined || __stringWithLength_23(value);
    }
  },
  onUncaughtException: {
    defaultValue: function () {
...
var getPrefixedConsole = function () {
  return __reduce_23(['debug', 'info', 'warn', 'error'], function (accum, method) {
...
var __getStack_26 = _$nodeFallbackStack_11.getStack,
    __maybeUseFallbackStack_26 = _$nodeFallbackStack_11.maybeUseFallbackStack;
...
var _$intercept_26 = {
  ...
  init: function (client) {
    var intercept = function (opts, cb) {
      ...
      var fallbackStack = __getStack_26();
      return function (err) {
        if (err) {
          // check if the stacktrace has no context, if so, if so append the frames we created earlier
          if (err.stack) __maybeUseFallbackStack_26(err, fallbackStack);
          var report = _$reportFromError_13(err, {
            severity: 'warning',
            unhandled: false,
            severityReason: {
...
var __isoDate_27 = _$esUtils_7.isoDate;
/*
...
var _$device_27 = {
  init: function (client) {
    ...
    client.device = ___extends_27({}, device, client.device); // add time just as the report is sent

    client.config.beforeSend.unshift(function (report) {
      report.device = ___extends_27({}, report.device, {
        time: __isoDate_27()
      });
...
var _$inProject_28 = {
  init: function (client) {
    return client.config.beforeSend.push(function (report) {
      ...
      report.stacktrace = __map_28(report.stacktrace, function (stackframe) {
...
var ___require_29 = require("fs"),
    createReadStream = ___require_29.createReadStream;

var ___require2_29 = require("stream"),
    Writable = ___require2_29.Writable;

var pump = require("pump");

var byline = require("byline");

var _$surroundingCode_29 = {
  init: function (client) {
...
function (_Writable) {
  ...
  function CodeRange(opts) {
    ...
    _this = _Writable.call(this, ___extends_29({}, opts, {
      decodeStrings: false
    })) || this;
...
var _$unhandledRejection_31 = {
  init: function (client) {
    if (!client.config.autoNotify) return;

    ___handler_31 = function (err) {
      client.notify(_$reportFromError_13(err, {
        severity: 'error',
        unhandled: true,
        severityReason: {
    ...
    process.on('unhandledRejection', ___handler_31);
  },
  destroy: function () {
    process.removeListener('unhandledRejection', ___handler_31);
  }
};
...
function ___inheritsLoose_34(subClass, superClass) { subClass.prototype = Object.create(superClass.prototype); subClass.prototype.constructor = subClass; subClass.__proto__ = superClass; }
...
/*#__PURE__*/
function (_Emitter) {
  ___inheritsLoose_34(SessionTracker, _Emitter);
...
var __isArray_33 = _$esUtils_7.isArray,
    __includes_33 = _$esUtils_7.includes;

/* removed: var _$inferReleaseStage_9 = require('@bugsnag/core/lib/infer-release-stage'); */;

var __intRange_33 = _$validators_15.intRange;

/* removed: var _$cloneClient_6 = require('@bugsnag/core/lib/clone-client'); */;

/* removed: var _$tracker_34 = require('./tracker'); */;

/* removed: var _$Backoff_32 = require('backo'); */;

var _$session_33 = {
  init: function (client) {
    var sessionTracker = new _$tracker_34(client.config.sessionSummaryInterval);
  ...
  configSchema: {
    sessionSummaryInterval: {
      ...
      validate: function (value) {
        return value === undefined || __intRange_33()(value);
      },
...
var sendSessionSummary = function (client) {
  return function (sessionCounts) {
    ...
    if (__isArray_33(client.config.notifyReleaseStages) && !__includes_33(client.config.notifyReleaseStages, releaseStage)) {
...
var __map_35 = _$esUtils_7.map;

/* removed: var _$pathNormalizer_12 = require('@bugsnag/core/lib/path-normalizer'); */;

var _$stripProjectRoot_35 = {
  init: function (client) {
    return client.config.beforeSend.push(function (report) {
      if (!client.config.projectRoot) return;
      var projectRoot = _$pathNormalizer_12(client.config.projectRoot);
      report.stacktrace = __map_35(report.stacktrace, function (stackframe) {
...
var __schema_24 = ___extends_24({}, _$config_4.schema, _$config_23); // remove autoBreadcrumbs from the config schema


delete __schema_24.autoBreadcrumbs;

/* removed: var _$surroundingCode_29 = require('@bugsnag/plugin-node-surrounding-code'); */;

/* removed: var _$inProject_28 = require('@bugsnag/plugin-node-in-project'); */;

/* removed: var _$stripProjectRoot_35 = require('@bugsnag/plugin-strip-project-root'); */;

/* removed: var _$session_33 = require('@bugsnag/plugin-server-session'); */;

/* removed: var _$device_27 = require('@bugsnag/plugin-node-device'); */;

/* removed: var _$uncaughtException_30 = require('@bugsnag/plugin-node-uncaught-exception'); */;

/* removed: var _$unhandledRejection_31 = require('@bugsnag/plugin-node-unhandled-rejection'); */;

/* removed: var _$intercept_26 = require('@bugsnag/plugin-intercept'); */;

/* removed: var _$contextualize_25 = require('@bugsnag/plugin-contextualize'); */;

var plugins = [_$surroundingCode_29, _$inProject_28, _$stripProjectRoot_35, _$session_33, _$device_27, _$uncaughtException_30, _$unhandledRejection_31, _$intercept_26, _$contextualize_25];

_$notifier_24 = function (opts, userPlugins) {
...
_$notifier_24['default'] = _$notifier_24;

return _$notifier_24;
