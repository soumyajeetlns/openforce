            ...
            <div className={"employeePopupWrapper"}>
                ...
                <div className={"hiredEmployeePopupBody " + this.props.swipeClass}>
                    ...
                    <div className={"left"}>
                        <div className={"header"}>
                            ...
                            <div className={"wrapperIcons"}>
                                ...
                                {this.state.apply && !this.state.apply.ended &&
                                    <Wrapper>
                                        <div className={"infoEmployee center hideNow"} onClick={this.setAutoApprove}>
                                        ...
                                        <div className={"infoEmployee center hideNow"} onClick={this.approveAllCheckins}>
                        ...
                        <div className={"wrapperCheckins hideNow"}>
