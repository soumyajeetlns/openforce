...
class EmployeePopup extends Component {
    ...
    componentDidMount = () => {
        ...
        const employeeId = this.props.employee.uid;
            jobsFunctions.getEmployeeData(employeeId, (employee) => {
                console.log("myemployee: "+JSON.stringify(employee));
                tempState.cvImageUrl = employee.cvImageUrl;
                ...
                <div className={"employeePopupBody"}>
                    ...
                    <div className={"left"}>
                        ...
                        <Col xs={9} className={"employeeNameDiv"}><div className={"employeeName"}>
                            ...
                            {this.state.cvImageUrl!==""?
                            <img src={this.state.cvImageUrl}/>
                            :null}
                                </div>
