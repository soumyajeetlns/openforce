...
import Invoice from "./components/home/map/apply/invoice/Invoice"
            ...
            <ErrorBoundary FallbackComponent={ErrorPage}>
                ...
                <BrowserRouter>
                    <Switch>
                        ...
                        <PrivateRoute path={"/invoice"} component={Invoice} authUser={this.props.ctr.user} type={constants.CLUSTER_EMPLOYER}/>
                    </Switch>
                </BrowserRouter>
            </ErrorBoundary>
        );
